import sqlite3
import os
import sys  # <--- MANCAVA QUESTO IMPORT!
from datetime import datetime

# =============================================================================
# FUNZIONE PER IL PERCORSO DEL DATABASE (DEVE ESSERE PRIMA DI TUTTO)
# =============================================================================
def get_db_path():
    """Restituisce il percorso corretto del database (funziona in sviluppo e in EXE)"""
    ...
    return os.path.join(db_dir, 'gestione.db')

# ORA possiamo usare la funzione (DOPO averla definita)
DB_PATH = get_db_path()
    ...
    try:
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           ultimo_acquisto TEXT,
                           fornitore TEXT,
                           immagine_percorso TEXT,
                           note TEXT
                       );
                       """)
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           note TEXT,
                           nome TEXT,
                           FOREIGN KEY (componente_id) REFERENCES magazzino(id)
                       );
                       """)
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           moltiplicatore REAL NOT NULL DEFAULT 3.0,
                           stato_vendita TEXT DEFAULT '',
                           immagine_percorso TEXT,
                           note TEXT,
                           percorso TEXT
                       );
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           spese_magazzino REAL NOT NULL,
                           spese_gestione REAL NOT NULL,
                           ricavi REAL NOT NULL,
                           utile_netto REAL NOT NULL,
                           data_creazione TEXT NOT NULL
                       );
                       """)
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           assemblato INTEGER DEFAULT 0,
                           data_lavorazione TEXT,
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           progetto_id INTEGER NOT NULL,
                           componente_id INTEGER NOT NULL,
                           quantita_mancante INTEGER NOT NULL,
        ...
        cursor.execute("""
                       ...
                       (
                           ...
                           tipo TEXT NOT NULL,
                           valore_originale REAL NOT NULL,
                           valore_residuo REAL NOT NULL,
                           data_creazione TEXT NOT NULL,
                           data_scadenza TEXT,
                           cliente_acquirente TEXT NOT NULL,
                           cliente_beneficiario TEXT,
                           note TEXT,
        ...
        cursor.execute("""
                       ...
                       (
                           id INTEGER PRIMARY KEY AUTOINCREMENT,
                           buono_id INTEGER NOT NULL,
                           vendita_id INTEGER,
                           data_utilizzo TEXT NOT NULL,
                           importo_utilizzato REAL NOT NULL,
                           note TEXT,
                           FOREIGN KEY (buono_id) REFERENCES buoni(id),
                           FOREIGN KEY (vendita_id) REFERENCES venduti(id)
                       );
                       """)
...
def get_db_path_original():
    """Restituisce il percorso del database (versione originale per compatibilità)."""
    return DB_PATH
